...
pub fn factory_presets() -> Vec<Preset> {
    vec![
        ...
        Preset {
            ...
            filter_cutoff: 350.0, filter_resonance: 0.1, filter_env_amount: 4000.0,
        ...
        Preset {
            ...
            a_attack: 0.001, a_decay: 0.3, a_sustain: 0.8, a_release: 0.15,
        ...
        Preset {
            ...
            osc_a_pw: 0.35, osc_a_level: 0.7, osc_b_level: 0.5,
            ...
            lfo_freq: 1.2, wm_pw_a: true, drift: 2.0,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            lfo_freq: 6.82, wm_pw_a: true, drift: 1.5,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            lfo_freq: 0.8, wm_pw_a: true, wm_pw_b: true, drift: 2.5,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            lfo_freq: 0.2, wm_filter: true, drift: 3.0,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            lfo_freq: 0.3, wm_filter: true, wm_pw_a: true, drift: 3.5,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            a_attack: 0.7, a_decay: 0.5, a_sustain: 1.0, a_release: 2.5,
            lfo_freq: 1.0, wm_pw_a: true, drift: 2.5,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            lfo_freq: 0.5, wm_pw_a: true, drift: 3.0,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            osc_a_saw: true, osc_b_saw: true,
            osc_a_level: 1.0, osc_b_level: 0.2,
        ...
        Preset {
            ...
            lfo_freq: 5.65, wm_freq_a: true, drift: 1.0,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            lfo_freq: 5.0, wm_freq_a: true, drift: 1.5,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            lfo_freq: 6.0, wm_freq_a: true, wm_freq_b: true, drift: 0.5,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            lfo_freq: 2.5, wm_pw_a: true, drift: 1.0,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            lfo_freq: 1.5, wm_pw_a: true, drift: 2.0,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            lfo_freq: 0.15, wm_filter: true, drift: 4.0,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            lfo_freq: 0.1, wm_filter: true, drift: 4.0,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            osc_a_pulse: true, osc_b_tri: true,
            osc_a_pw: 0.5,
            osc_a_level: 0.8, osc_b_level: 0.3,
            ...
            pm_osc_b: 0.3, pm_freq_a: true, drift: 1.5,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            osc_a_saw: true, osc_b_tri: true,
            osc_a_level: 0.9, osc_b_level: 0.1,
            filter_cutoff: 6000.0, filter_resonance: 0.05, filter_env_amount: 4000.0,
            f_attack: 0.001, f_decay: 2.0, f_sustain: 0.0, f_release: 1.5,
            a_attack: 0.001, a_decay: 2.5, a_sustain: 0.0, a_release: 1.5,
            pm_osc_b: 0.35, pm_freq_a: true, drift: 1.0,
            ..Preset::default()
        },
        ...
        Preset {
            ...
            pm_osc_b: 0.5, pm_freq_a: true, pm_filter: true, drift: 3.0,
            ..Preset::default()
        },
        // Laser zap
        Preset {
