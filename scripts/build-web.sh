...
cargo build -p tb303-wasm --target wasm32-unknown-unknown --release
cargo build -p braids-wasm --target wasm32-unknown-unknown --release
...
cp "$ROOT/target/wasm32-unknown-unknown/release/tb303_wasm.wasm" "$ROOT/orbit/public/tb303.wasm"
cp "$ROOT/target/wasm32-unknown-unknown/release/braids_wasm.wasm" "$ROOT/orbit/public/braids-dsp.wasm"
